...
public class CrossDriver {
    ...
    static WebDriver driver;
     ...
     public static WebDriver getDriver(String browser) {
         ...
         //Eğer browsera bir değer atanmamıssa configuration properties taki browser çalıssın
         browser = browser==null ? ConfigReader.getProperty("browser") : browser;


         //Testlerimizi xml file dan farklı browserlar ile çalıstırabilmek için getDriver() methoduna parametre
         //atamamız gerekir
        if (driver == null) {
            switch (browser){
